...
export namespace Prisma {
  ...
  */
  ...
  export type ShapeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    description?: boolean
    userId?: boolean
    User?: boolean | Shape$UserArgs<ExtArgs>
  ...
  export type ShapeOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "width" | "height" | "radius" | "description" | "userId", ExtArgs["result"]["shape"]>
  ...
  export interface Prisma__ShapeClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    User<T extends Shape$UserArgs<ExtArgs> = {}>(args?: Subset<T, Shape$UserArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface ShapeFieldRefs {
    ...
    readonly name: FieldRef<"Shape", 'String'>
    readonly width: FieldRef<"Shape", 'Float'>
    readonly height: FieldRef<"Shape", 'Float'>
    readonly radius: FieldRef<"Shape", 'Float'>
    readonly description: FieldRef<"Shape", 'String'>
    readonly userId: FieldRef<"Shape", 'Int'>
  }
   ...
   * Shape.User
   */
  export type Shape$UserArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the User
     */
    select?: UserSelect<ExtArgs> | null
  ...
  export const ShapeOrderByRelevanceFieldEnum: {
    name: 'name',
    description: 'description'
  };

  export type ShapeOrderByRelevanceFieldEnum = (typeof ShapeOrderByRelevanceFieldEnum)[keyof typeof ShapeOrderByRelevanceFieldEnum]
  ...
  export type ShapeWhereInput = {
    ...
    name?: StringFilter<"Shape"> | string
    width?: FloatFilter<"Shape"> | number
    height?: FloatFilter<"Shape"> | number
    radius?: FloatFilter<"Shape"> | number
    description?: StringFilter<"Shape"> | string
    userId?: IntNullableFilter<"Shape"> | number | null
  ...
  export type ShapeOrderByWithRelationInput = {
    ...
    _relevance?: ShapeOrderByRelevanceInput
  }
  ...
  export type ShapeScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter<"Shape"> | string
    width?: FloatWithAggregatesFilter<"Shape"> | number
    height?: FloatWithAggregatesFilter<"Shape"> | number
    radius?: FloatWithAggregatesFilter<"Shape"> | number
    description?: StringWithAggregatesFilter<"Shape"> | string
    userId?: IntNullableWithAggregatesFilter<"Shape"> | number | null
  }
  ...
  export type ShapeUpdateInput = {
    ...
    User?: UserUpdateOneWithoutShapesNestedInput
  }
  ...
  export type ShapeOrderByRelevanceInput = {
    fields: ShapeOrderByRelevanceFieldEnum | ShapeOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
  ...
  export type UserUpdateOneWithoutShapesNestedInput = {
    create?: XOR<UserCreateWithoutShapesInput, UserUncheckedCreateWithoutShapesInput>
    connectOrCreate?: UserCreateOrConnectWithoutShapesInput
